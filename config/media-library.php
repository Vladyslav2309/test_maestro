...
return [
     ...
     */
    'max_file_size' => 1024 * 1024 * 500, // 300MB
    ...
    'image_optimizers' => [
        ...
        Spatie\ImageOptimizer\Optimizers\Cwebp::class => [
            '-m 4', // for the slowest compression method in order to get the best compression.
            '-pass 10', // for maximizing the amount of analysis pass.
            '-mt', // multithreading for some speed improvements.
            '-q 96', // quality factor that brings the least noticeable changes.
        ],
